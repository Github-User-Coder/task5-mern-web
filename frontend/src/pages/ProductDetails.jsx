                    ...
                    <div className='flex gap-2 lg:flex-col overflow-scroll scrollb-none h-full'>
                        {
                            productImagelist.map(el =>{
                                return(
                                 <div className='h-20 w-20 bg-slate-200 rounded animate-pulse' key={"loading"}>
               ...
               loading ? (
                ...
                <FaRegStarHalfStroke />
                    ...
                    <div className='flex items-center gap-3 my-2'>
                        ...
                        <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[100px]  font-medium text-white bg-red-600 hover:text-red-600 hover:bg-white'>Add to cart</button>
                    </div>
                    <div>
